...
| -------------------------- | ---------------------- | --------------- |
| Active Directory Audit Log | `azure_ad_audit_event` | `Record`        |
...
| ------------------------- | --------------------- | ---------------------- |
| `azure_ad_audit_event`    | **UPDATED**           | `azure_ad_resource`    |
| `azure_service_principal` | **PERFORMED**         | `azure_ad_audit_event` |
| `azure_user`              | **PERFORMED**         | `azure_ad_audit_event` |
